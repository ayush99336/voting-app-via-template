...
export type SetInput<TAccountVotingappviatemplate extends string = string> = {
...
>(
  input: SetInput<TAccountVotingappviatemplate>,
  ...
  } as SetInstruction<TProgramAddress, TAccountVotingappviatemplate>;
