...
import { VOTINGAPPVIATEMPLATE_PROGRAM_ADDRESS } from '../programs';
...
export type DecrementInstruction<
  TProgram extends string = typeof VOTINGAPPVIATEMPLATE_PROGRAM_ADDRESS,
  TAccountVotingappviatemplate extends string | AccountMeta<string> = string,
  TRemainingAccounts extends readonly AccountMeta<string>[] = [],
> = Instruction<TProgram> &
  InstructionWithData<ReadonlyUint8Array> &
  InstructionWithAccounts<
    [
      TAccountVotingappviatemplate extends string
        ? WritableAccount<TAccountVotingappviatemplate>
...
export type DecrementInput<TAccountVotingappviatemplate extends string = string> = {
...
>(
  input: DecrementInput<TAccountVotingappviatemplate>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountVotingappviatemplate> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.votingappviatemplate)],
    programAddress,
    data: getDecrementInstructionDataEncoder().encode({}),
  } as DecrementInstruction<TProgramAddress, TAccountVotingappviatemplate>;
...
> = {
  ...
  accounts: {
    votingappviatemplate: TAccountMetas[0];
  };
...
>(
  ...
  return {
    ...
    accounts: {
      votingappviatemplate: getNextAccount(),
    },
